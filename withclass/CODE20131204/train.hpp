...
#include "resource.hpp"
    ...
    class Arrival
    {
        ...
        public:
            ...
            void setupFromFile(FILE * pFile) 
            {
                fscanf(pFile, "Arr%d;Train%d;", &arrivalID, &id);
    ...
    class Train
    {
        ...
        public:
            ...
            void setCurrentResourceP(Resource& r)
            {
                currentResourceP = & r;
            }
            ...
            void print()
            {
                std::cout << "Train" << id 
                    ...
                    << "\ncurrentResource: ";
                ///////////////////////////////////////////////currentResourceP->print();
                std::cout << (char)(currentResource+'A') << currentResourceNumber ;
                std::cout << "\nremDBM: " << remDBM
                    << "\nremTBM: " << remTBM.day << " " 
            ...
            {
                fscanf(pFile, "Train%d;Cat%d;", &id, &category);
